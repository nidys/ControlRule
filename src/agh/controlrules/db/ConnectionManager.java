...
public class ConnectionManager {
	...
	private static final String DB_CONNECTION = "jdbc:postgresql://localhost:5432/control_rules_db";
	...
	public static Connection getDBConnection() {
		...
		try {
			Logger.error("Connecting to=%s, u=%s, p=%s", DB_CONNECTION, DB_USER, DB_PASSWORD);
